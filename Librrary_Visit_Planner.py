...
elif weather == "sunny" and book_due == "yes":
    print("Best plan:R eturn your book.")

elif day in ("Saturday", "Sunday") and weather == "sunny":
    print("Best plan: Reading session at the library!")
else:
    print("Best plan:Plan a library visit.")
